...
root.render(heading); // convert react into html*/ // create nested elems
...
console.log(parent);
const root = ReactDOM.createRoot(document.getElementById("root"));
root.render(parent);*/ // nested elem with multi childs as array
...
root.render(parent); // its very complex like there JSX comes into picture to reduce and make our life easy

},{}]},["adBpN","igcvL"], "igcvL", "parcelRequire164e")
